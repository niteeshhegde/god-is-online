...
<div>
<form class="form-inline" role="form" align="center" action="projects2.php"   method="get">
  <div class="form-group">
<label for="sel1">LOCATION : </label>

                    <select data-placeholder="Choose City..." id="city_sidebar" name="city1" class="form-control" id="sel1" tabindex="2">
      ...
      <select class="form-control" id="sel1" name="category1">
...
<div id = "tempd">
 <div class="row" align="center">
    <div class="col-sm-4" style="background-color:red;" >
      <img src="bull-temple-bangalore.jpg" alt="Mountain View" style="height:177px;">
    </div>
  ...
  <thead>
    <tr><td ><h4>BULL TEMPLE </h4></td><td ><h4> Basavanagudi, Bengaluru</h4></td></tr>
  </thead>
  <tbody>

    <tr >
    </tr>
    <tr><td colspan='2'>The temple is dedicated to Nandi Bull, the guard of Lord Shiva. The temple houses a 4.6 meter tall image of Nandi bull. </td></tr>
    <tr >
    </tr>
	 <tr><td colspan='2'><a href='prodet.php?id=".$arry['pid']."' id= 'vp' class='btn btn-default btn-lg btn-block'>View More</a></td></tr>
  </tbody>
</table> 
    </div>
  </div>
...
<div id = "tempd">
 <div class="row" align="center">
    <div class="col-sm-4" style="background-color:red;" >
      <img src="Iskcon-bangalore.jpg" alt="Mountain View" style="height:177px;">
    </div>
    <div class="col-sm-8" style="background-color:red;" style="height:233px;">
      <table class='table table-striped table-hover ' text-align='center' id="table">
  <thead>
    <tr><td ><h4>ISKCON </h4></td><td ><h4> Rajaji Nagara, Bengaluru</h4></td></tr>
  </thead>
  <tbody>

    <tr >
    </tr>
    <tr><td colspan='2'>Sri Radha Krishna Temple has deities of Radha and Krishna. It is one of the largest ISKCON temples in the world.</td></tr>
    <tr >
    </tr>
	 <tr><td colspan='2'><a href='prodet.php?id=".$arry['pid']."' id= 'vp' class='btn btn-default btn-lg btn-block'>View More</a></td></tr>
  </tbody>
