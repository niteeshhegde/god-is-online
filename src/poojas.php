...
<div id = "tempd">
 <div class="row" align="center">
    <div class="col-sm-4" style="background-color:red;" >
      ...
      <img src="'.$arry["image"].'" id="image1" alt="image" style="width:157px;height:157px;">
    </div>
  ...
  <thead>
    <tr><td ><h4>'. $arry["name"].'</h4></td><td ><h4>'. $arry["locality"].','. $arry["location"].'</h4></td></tr>
  </thead>
  <tbody>

    <tr >
    </tr>
    <tr><td colspan="2">'.substr($arry["description"],0,50).' </td></tr>
    <tr >
    </tr>
	 <tr><td colspan="2"><a href="desctemp.php?id='.$arry["id"].'" id= "vp" class="btn btn-default btn-lg btn-block">View More</a></td></tr>
  </tbody>
</table> 
    </div>
  </div>
