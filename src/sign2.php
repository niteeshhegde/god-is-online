...
<div class="container">
  <h2>Sign in</h2>
	...
	<div class="form-group">
			...
			<small ><a href='fp21.php'>  &#160;	&#160;	Forgot Password ?</a></small> 
        </div>

  </form>
    <div id="300"> <br /> <br /> </div>
	  <h2> Or Sign up</h2>
	  <form class="form-horizontal" action="savepandit.php" method="post" enctype="multipart/form-data">
  <fieldset>
    <div class="form-group">
  ...
  <label class="col-lg-2 control-label" for="focusedInput">Name </label>
    <div class="col-lg-10">
  <input class="form-control" id="focusedInput" name="name" type="text" value=""></div>
</div>
			<div class="form-group">
  <label class="col-lg-2 control-label" for="focusedInput">Phone no </label>
    <div class="col-lg-10">
  <input class="form-control" id="focusedInput" name="phone" type="text" value=""></div>
</div>
<div class="form-group">
