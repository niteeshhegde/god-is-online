...
$query = "SELECT id,password,name,phone,location,MarriageCeremony,NamingCeremony,Upanayana,Gruhapravesh,SatyanarayanaKatha,image FROM pandits WHERE email =?";
...
if($count==1){
    ...
    $g->bind_result($id,$password,$name,$phone,$location,$MarriageCeremony,$NamingCeremony,$Upanayana,$Gruhapravesh,$SatyanarayanaKatha,$image);
    /* fetch values */
    while ($g->fetch()) {
        $id2=$id;
		$password2=$password;
		...
		$phone2=$phone;
		$location2=$location;
		$MarriageCeremony2=$MarriageCeremony;
		$NamingCeremony2=$NamingCeremony;
		$Upanayana2=$Upanayana;
		$Gruhapravesh2=$Gruhapravesh;
		$SatyanarayanaKatha2=$SatyanarayanaKatha;
		$image2=$image;
    }
	if(password_verify($mypassword,$password)){
		...
		$phone1=$phone;
		$location1=$location2;
		$MarriageCeremony1=$MarriageCeremony2;
		$NamingCeremony1=$NamingCeremony2;
		$Upanayana1=$Upanayana2;
		$Gruhapravesh1=$Gruhapravesh2;
		$SatyanarayanaKatha1=$SatyanarayanaKatha2;
		$image1=$image2;
    }
	}
echo '
...
<img src="'.$image1.'" alt="Pandit"  style="width:277px;height:277px;">
	  ...
	  <form class="form-horizontal" action="savset2.php" method="post" enctype="multipart/form-data">
  <fieldset>
  ...
  <label class="col-lg-2 control-label" for="focusedInput">Phone no </label>
    <div class="col-lg-10">
  <input class="form-control" id="focusedInput" name="phone" type="text" value="'.$phone1.'"></div>
</div>
<div class="form-group">
<label for="sel1" class="col-lg-2 control-label">LOCATION : </label>
  ...
  <div class="form-group">
<label for="sel1" class="col-lg-2 control-label">  Can you perform marriage ceremony ? </label>
           <div class="col-lg-10"> <select class="form-control" id="sel1" name="marriage">
	  	      <option value="MarriageCeremony,">Yes </option>
  <option value="">No</option>
	  ...
	  <div class="form-group">
<label for="sel1" class="col-lg-2 control-label">  Can you perform naming ceremony ? </label>
           <div class="col-lg-10"> <select class="form-control" id="sel1" name="naming">
	  	      <option value="NamingCeremony,">Yes </option>
  <option value="">No</option>
	  ...
	  <div class="form-group">
<label for="sel1" class="col-lg-2 control-label">  Can you perform Upanayana ? </label>
           <div class="col-lg-10"> <select class="form-control" id="sel1" name="upanayana">
	  	      <option value="Upanayana,">Yes </option>
  <option value="">No</option>
	...
	<div class="form-group">
<label for="sel1" class="col-lg-2 control-label">  Can you perform Gruhapravesh ? </label>
           <div class="col-lg-10"> <select class="form-control" id="sel1" name="gruhapravesh">
	  	      <option value="Gruhapravesh,">Yes </option>
  <option value="">No</option>
	...
	<div class="form-group">
<label for="sel1" class="col-lg-2 control-label">  Can you perform Satyanarayana katha ? </label>
           <div class="col-lg-10"> <select class="form-control" id="sel1" name="satyanarayana">
	  	      <option value="SatyanarayanaKatha">Yes </option>
  <option value="">No</option>
	 ...
	 <form class="form-horizontal" method="post" name="signup" id="signup" enctype="multipart/form-data" action="picsavset2.php">        
		<div class="form-group">
