...
<h2> Or </h2>
<h2> Sign Up </h2>
	<form class="form-horizontal" action="savtempl.php" method="post" enctype="multipart/form-data">
  <fieldset>
    <div class="form-group">
...
<div class="form-group" >
  ...
  <div class="col-lg-10">
  <input class="form-control" id="focusedInput" name="locality" type="text" placeholder="Eg. Basavangudi"></div>
</div>
<div class="form-group" >
...
<br />
	...
	<div class="form-group">
      ...
      <div class="col-lg-10">
        <textarea class="form-control" rows="3" name="history" id="textArea"></textarea>
      </div>
    </div>
	<div class="form-group">
      <label for="textArea" class="col-lg-2 control-label">Timing</label>
      <div class="col-lg-10">
        <textarea class="form-control" rows="3" name="time" id="textArea"></textarea>
      </div>
    </div>
	<div class="form-group">
