...
while($arry = mysqli_fetch_array($result)){
 ...
 <div class="row" align="center">
    <div class="col-sm-4" style="background-color:red;" >
      <img src="'.$arry["image"].'" alt="image" style="height:153px;">
    </div>
  ...
  <thead>
    <tr><td ><h4>'.$arry["name"].'</h4></td><td ><h4> Location : '.$arry["location"].'</h4></td></tr>
  </thead>
  <tbody>
    <tr >
    </tr>
    <tr><td colspan="2">Phone : '.$arry["phone"].'</td></tr>
    <tr >
    </tr>
      <tr><td colspan="2">Skills : '.$arry["MarriageCeremony"].'   '.$arry["NamingCeremony"].'    '.$arry["Upanayana"].'    '.$arry["Gruhapravesh"].'    '.$arry["SatyanarayanaKatha"].' </td></tr>
